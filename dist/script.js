...
var forms = function forms() {
  ...
  var form = document.querySelectorAll("form"),
      ...
      phoneInputs = document.querySelectorAll("input[name='user_phone']"); //реализуем функциональность цифрового ввода в поле для телефона
  ...
  form.forEach(function (item) {
    item.addEventListener("submit", function (e) {
      ...
      var formData = new FormData(item); //передаем данные на сервер
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var trigger = document.querySelectorAll(triggerSelector),
        ...
        close = document.querySelector(closeSelector); //делаем переиспользуемую функцию для закрытия модальных окон
